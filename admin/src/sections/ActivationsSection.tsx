// src/sections/ActivationsSection.tsx
...
interface Props {
	...
	onChange: (value: ActivationsData) => void;
}

export default function ActivationsSection({ data, onChange }: Props) {
	function update<K extends keyof ActivationsData>(
		key: K,
		value: ActivationsData[K],
	) {
